        ...
        <div class="support">
            ...
            if (function_exists("sola_t_register_pro")) { 
                ...
                <p><?php _e('Sola Testimonials Premium Version: ', 'sola_t'); ?><a target='_BLANK' href="http://solaplugins.com/plugins/sola-testimonials/?utm_source=plugin&utm_medium=link&utm_campaign=sola_t_version_premium"><?php echo $sola_t_pro_version." ".$sola_t_pro_version_string; ?></a> |
                    <a target="_blank" href="http://solaplugins.com/support-desk/"><?php _e('Support', 'sola_t'); ?></a></p>
                <?php } else { 
                    ...
                    <a target="_blank" id="upgrade" href="http://solaplugins.com/plugins/sola-testimonials/?utm_source=plugin&utm_medium=link&utm_campaign=sola_t_footer" title="Premium Upgrade"><?php _e('Go Premium', 'sola_t'); ?></a>
                <?php } ?>
        </div>
    </div>
</div>